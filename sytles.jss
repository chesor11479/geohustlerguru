...
.project {
    ...
    background: #fff;
    border-radius: 10px;
    box-shadow: 0 4px 8px rgba(58, 51, 119, 0.29);
}
...
.certificate {
    ...
    background: #fff;
    border-radius: 10px;
    box-shadow: 0 4px 8px rgba(36, 163, 113, 0.37);
    text-align: center;
}
...
#contact {
    ...
    background: #fff;
    border-radius: 10px;
    box-shadow: 0 4px 8px rgba(222, 53, 53, 0.1);
}
...
#experience {
    ...
    background: #fff;
    border-radius: 10px;
    box-shadow: 0 4px 8px hsla(154, 78.30%, 41.60%, 0.82);
}

.experience-item {
    margin-bottom: 30px;
    padding: 20px;
    background:rgb(19, 123, 147);
    border-radius: 10px;
}
...
/* Ensure Sections Have a Semi-Transparent Background */
section {
...
>>>>>>> b4c3286 (Updated portfolio with new changes)
